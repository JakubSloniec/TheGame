...
//        System.out.println(prettyGameMapString2);
        ...
        MapConfigReader mapConfigReader = new MapConfigReader();
        RawMap mapLev1 = mapConfigReader.readMapConfig("plotConfig/mapLev1.json");
        String prettyMapLev1 = mapConfigReader.prettyPrint(mapLev1);
        System.out.println(prettyMapLev1);
    }
}
